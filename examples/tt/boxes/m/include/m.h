 ...
 * @file    m_custom.h
 *
 * This file holds custom definitions for the streamix box m.
 ...
 * m_init() and freed in the function m_free().
 */
...
/** ::m_state_s */
typedef struct m_state_s m_state_t;

/**
 * The state structure of m.
 */
struct m_state_s
{
    // ADD STATE FIELDS
 ...
 *  allocated in m_init() and freed in m()_cleanup.
 * @return
