 ...
 * @file    m_custom.h
 *
 * This file holds custom message data types for the streamix box m.
 *
...
/** ::m_x_data_s */
typedef struct m_x_data_s m_x_data_t;
 ...
 */
void* m_x_copy( void* data, size_t size );
